...
class Scramble():
    ...
    def scrambleGenerator(self, length, choice, puzzleType):
        ...
        if puzzleType == "4x4":
            ...
            try:
                while len(self.scrambleSet) < length: #Needed Help for setting the condition for the scramble to prevent repetitions of the same character
...
class Timer():
    ...
    #Needed Help to convert into specific time format
    ...
    #Used for calculating averages whilst extracting best and worst time (used with Help and works perfectly)
    def calculate_average(self, number):
        ...
        #Help in cleaning the program for readability
